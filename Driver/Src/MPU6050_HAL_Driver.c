...
void MPU6050_INIT(I2C_HandleTypeDef hi2c1){
    HAL_I2C_Mem_Read(&hi2c1,MPU6050_I2C_ADDR,MPU6050_WHO_AM_I,1,&HU_MI,1,MPU6050_I2C_TIMEOUT);

    if(HU_MI == 68){
        DATA_2_WRITE = MPU6050_PWR_MGMT_1_DEF;
        HAL_I2C_Mem_Write(&hi2c1,MPU6050_I2C_ADDR,MPU6050_PWR_MGMT_1,I2C_MEMADD_SIZE_8BIT,&DATA_2_WRITE,1,MPU6050_I2C_TIMEOUT);
        
        DATA_2_WRITE = MPU6050_SAMPLE_RATE_DIV_DEF;
        HAL_I2C_Mem_Write(&hi2c1,MPU6050_I2C_ADDR,MPU6050_SAMPLE_RATE_DIV,I2C_MEMADD_SIZE_8BIT,&DATA_2_WRITE,1,MPU6050_I2C_TIMEOUT);
        
        DATA_2_WRITE = MPU6050_CONFIG_DEF;
        HAL_I2C_Mem_Write(&hi2c1,MPU6050_I2C_ADDR,MPU6050_CONFIG,I2C_MEMADD_SIZE_8BIT,&DATA_2_WRITE,1,MPU6050_I2C_TIMEOUT);
        
        DATA_2_WRITE = MPU6050_GYRO_CONFIG_DEF;
        HAL_I2C_Mem_Write(&hi2c1,MPU6050_I2C_ADDR,MPU6050_GYRO_CONFIG,I2C_MEMADD_SIZE_8BIT,&DATA_2_WRITE,1,MPU6050_I2C_TIMEOUT);
        
        DATA_2_WRITE = MPU6050_ACCEL_CONFIG_DEF;
        HAL_I2C_Mem_Write(&hi2c1,MPU6050_I2C_ADDR,MPU6050_ACCEL_CONFIG,I2C_MEMADD_SIZE_8BIT,&DATA_2_WRITE,1,MPU6050_I2C_TIMEOUT);
